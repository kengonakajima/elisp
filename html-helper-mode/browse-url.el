...
;; 0.31 28 Apr 1996
;;	Added browse-url command.
;;	Added new-window logic to b-u-interactive-arg.
;;	b-u-file-url checks for EFS path.

;; 0.32 02 May 1996
;;	Improved b-u-url-at-point matching to supply missing "http://".

;; 0.33 01 Jun 1996
;;	Jari Aalto <jaalto@tre.tele.nokia.fi> browse-url-lynx-emacs
;;	fix.  Thanks Jari.

;; 0.34 05 Jun 1996
;;	b-u-file-url checks for EFS after alist.  Thanks
;;	Jens-U H Petersen <petersen@kurims.kyoto-u.ac.jp>

;; 0.35 11 Jun 1996
;;	Grail support.  Thanks Barry A. Warsaw
;;	<bwarsaw@anthem.cnri.reston.va.us>.

;; 0.36 12 Jun 1996
;;	Fixed browse-url-looking-at (I hope).

;; 0.37 15 Jun 1996
;;	b-u-file-url URL-encodes special chars.
;;	Thanks Martin Schwenke <Martin.Schwenke@cs.anu.edu.au>.

;; 0.38 17 Jun 1996
;;	b-u-file-url encodes fewer chars.  Multi-display support for
;;	Netscape.  Thanks Richard Mlynarik <mly@adoc.xerox.com>
...
Convert EFS file names of the form /USER@HOST:PATH to ftp://HOST/PATH."
  ...
  (while (string-match "[*\"()',=;? ]" file)
    (setq enc (format "%%%x" (aref file (match-beginning 0)))
	  file (replace-match enc t t file)))
